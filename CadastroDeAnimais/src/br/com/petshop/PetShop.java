...
public class PetShop {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("3 - Cadastrar Roedor");
...
case 3:
				...
				System.out.print("Nome do roedor: ");
				String nomeRoedor = scanner.nextLine();
				System.out.print("Idade do roedor: ");
				int idadeRoedor = scanner.nextInt();
				scanner.nextLine();
				System.out.print("Tipo de roedor: ");
				String racaRoedor = scanner.nextLine();
				animais.add(new Roedor(nomeRoedor, idadeRoedor, racaRoedor));
				System.out.print("Roedor cadastrado com sucesso!");
				break;
